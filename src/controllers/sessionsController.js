...
import  DMAilTemplates from "../constants//mailTemplates.js";

import { usersService} from "../services/index.js";
import   auth from "../services/auth.js";
import  errorHandler from "../helpers/errorHandler.js";
import {updateConnection} from "../helpers/lastConnection.js";
...
const passwordRestore = async (req, res, next) => {
  try {
    ...
    try {
      ...
      const isSamePassword = await auth.validatePassword(
        newPassword,
        user.password
      );
      if (isSamePassword) {
